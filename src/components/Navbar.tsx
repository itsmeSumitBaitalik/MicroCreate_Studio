  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 px-4 pt-4 sm:px-6 sm:pt-6">
      <nav
        ...
        <Link to="/" className="flex shrink-0 items-center" aria-label="Microcrete Studio — home">
          <img src={LOGO_SRC} alt="Microcrete Studio" className="h-10 w-auto sm:h-12" />
        </Link>
        ...
        <motion.div
          ...
          className="mx-auto mt-3 max-w-6xl overflow-hidden rounded-3xl border border-ink/10 bg-cream/95 p-3 shadow-xl backdrop-blur-md lg:hidden">
            ...
            <li key={link.to}>
                ...
                className="block rounded-2xl px-4 py-3 font-display text-2xl text-ink transition-colors hover:bg-sand">
            ...
            to="/contact"
            onClick={() => setOpen(false)}
            className="mt-2 flex items-center justify-between rounded-2xl bg-ink px-5 py-4 text-sm font-medium text-cream">
