...
const HERO_IMAGE = "/home_page_hero.webp";
const HERO_IMAGE_MOBILE = "/home_page_hero.webp";

export function Hero() {
  return (
    <section className="relative w-full overflow-hidden bg-ink">
      {/* Responsive hero: portrait 9:16 on mobile, landscape on sm+ */}
      <motion.picture
      ...
      <div className="relative mx-auto flex min-h-[100svh] max-w-6xl flex-col justify-end px-4 pb-14 pt-32 sm:px-6 sm:pb-20">
        ...
        >
          Surfaces That
          <span className="block italic text-clay">Define Spaces.</span>
        </motion.h1>
        <motion.p
        ...
        >
          Limewash, marmorino, travertine and seamless microcement floors —
          mineral finishes troweled on site. Where every surface is uniquely
          yours.
        </motion.p>
